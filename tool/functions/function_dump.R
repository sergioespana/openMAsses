# This file contains all functions that server can call, hopefully I can make some cheese of it
# and group them by functionality into seperate scripts, because this is just 1100 lines of mess.
